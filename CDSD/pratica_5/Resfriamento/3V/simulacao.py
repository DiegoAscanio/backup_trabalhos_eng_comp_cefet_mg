...
Y = Y[time_Y.index(90.):]
time_Y = [t - 90. for t in time_Y[time_Y.index(90.):]]
...
# simulacao
#y_0 = 0.297
print(gma(0.38, 0.033, 0.24))
time_sim, y_ma_sim, states = scipy.signal.lsim(gma(0.38, 0.033, 0.24), U, time_U)
y_sim = [f(0.38, 0.033, 0.24, t) for t in time_Y]
