...
def foodHeuristic(state, problem):
  ...
  for goalX, goalY in foodGrid.asList():
    distancia = ((goalX - positionX)**2 + (goalY - positionY)**2)**0.5
    menorDistancia = distancia if distancia < menorDistancia else menorDistancia
